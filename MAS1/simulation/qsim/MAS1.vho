...
-- Z[1]	=>  Location: PIN_P5,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Z[2]	=>  Location: PIN_H1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Z[3]	=>  Location: PIN_R3,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Z[4]	=>  Location: PIN_M8,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF MAS1 IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \I3|Cout~combout\ = (\A[2]~input_o\ & (\A[3]~input_o\ & (\A[0]~input_o\ & \A[1]~input_o\)))
...
-- Equation(s):
-- \Z~0_combout\ = \I3|Cout~combout\ $ (\A[4]~input_o\)
