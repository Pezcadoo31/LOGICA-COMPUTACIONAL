...
-- Equation(s):
-- \Mux6~0_combout\ = (\BCD[2]~input_o\ & (((\BCD[3]~input_o\) # (!\BCD[0]~input_o\)))) # (!\BCD[2]~input_o\ & ((\BCD[1]~input_o\ & ((\BCD[3]~input_o\))) # (!\BCD[1]~input_o\ & (\BCD[0]~input_o\ & !\BCD[3]~input_o\))))
...
-- Equation(s):
-- \Mux4~0_combout\ = (\BCD[1]~input_o\ & (((\BCD[3]~input_o\) # (!\BCD[0]~input_o\)))) # (!\BCD[1]~input_o\ & (\BCD[2]~input_o\ & ((\BCD[3]~input_o\))))
...
-- Equation(s):
-- \Mux3~0_combout\ = (\BCD[1]~input_o\ & ((\BCD[2]~input_o\) # ((\BCD[3]~input_o\)))) # (!\BCD[1]~input_o\ & (\BCD[2]~input_o\ $ (((\BCD[0]~input_o\ & !\BCD[3]~input_o\)))))
...
-- Equation(s):
-- \Mux2~0_combout\ = (\BCD[2]~input_o\) # ((\BCD[0]~input_o\) # ((\BCD[1]~input_o\ & \BCD[3]~input_o\)))
...
-- Equation(s):
-- \Mux1~0_combout\ = (\BCD[1]~input_o\) # ((\BCD[2]~input_o\ & ((\BCD[3]~input_o\))) # (!\BCD[2]~input_o\ & (\BCD[0]~input_o\ & !\BCD[3]~input_o\)))
...
-- Equation(s):
-- \Mux0~0_combout\ = (\BCD[2]~input_o\ & (!\BCD[1]~input_o\ & !\BCD[3]~input_o\)) # (!\BCD[2]~input_o\ & (\BCD[1]~input_o\ $ (\BCD[3]~input_o\)))
